...
class Context:
    ...
    def cargarInventario():
        ...
        try:
            ...
            with open(INVENTARIODB, 'r') as jsonFile: lines = jsonFile.read()
    ...
    def updateInventario(inventario):
        ...
        try:
            with open(INVENTARIODB,'w') as jsonFile: jsonFile.write(update)
    ...
    def updatePersonal(personal):
        ...
        update = json.dumps(inventario)
        try:
            with open(PERSONALDB,'w') as jsonFile: jsonFile.write(update)
        except Exception as e:
            print("Error en la escritura del archivo")
            print("Error: ",e)